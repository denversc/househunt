# Pippin's Detective Agency: Clues & Setup Guide

This document lists all the physical cards you need to write out and hide around the house, along with the answers your daughter will type into the app.

---

### Clue Setup Table

| Clue # | Hidden Location | What to Write on the Physical Clue Card | Expected App Answer |
| :--- | :--- | :--- | :--- |
...
| **Clue #5** | **Shed** (Outside) | "I have long ears, a twitchy pink nose, and I hop around the grass eating carrots. What am I? (5 letters)" | **`BUNNY`** |
